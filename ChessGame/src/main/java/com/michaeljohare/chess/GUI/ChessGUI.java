    ...
    private void updateButton(int row, int col) {
        ...
        if (board[row][col].startsWith(PAWN)) {
            if (board[row][col].endsWith(PLAYER_1)) {
                try {
                    Image whitePawn = ImageIO.read(ChessGUI.class.getResource("/White_Pawn.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(whitePawn));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            } else {
                try {
                    Image blackPawn = ImageIO.read(ChessGUI.class.getResource("/Black_Pawn.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(blackPawn));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            }
        ...
        if (board[row][col].startsWith(ROOK)) {
            if (board[row][col].endsWith(PLAYER_1)) {
                try {
                    Image whiteRook = ImageIO.read(ChessGUI.class.getResource("/White_Rook.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(whiteRook));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            } else {
                try {
                    Image blackRook = ImageIO.read(ChessGUI.class.getResource("/Black_Rook.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(blackRook));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            }
        ...
        if (board[row][col].startsWith(BISHOP)) {
            if (board[row][col].endsWith(PLAYER_1)) {
                try {
                    Image whiteBishop = ImageIO.read(ChessGUI.class.getResource("/White_Bishop.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(whiteBishop));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            } else {
                try {
                    Image blackBishop = ImageIO.read(ChessGUI.class.getResource("/Black_Bishop.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(blackBishop));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            }
        ...
        if (board[row][col].startsWith(KNIGHT)) {
            if (board[row][col].endsWith(PLAYER_1)) {
                try {
                    Image whiteKnight = ImageIO.read(ChessGUI.class.getResource("/White_Knight.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(whiteKnight));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            } else {
                try {
                    Image blackKnight = ImageIO.read(ChessGUI.class.getResource("/Black_Knight.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(blackKnight));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            }
        ...
        if (board[row][col].startsWith(KING)) {
            if (board[row][col].endsWith(PLAYER_1)) {
                try {
                    Image whiteKing = ImageIO.read(ChessGUI.class.getResource("/White_King.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(whiteKing));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            } else {
                try {
                    Image blackKing = ImageIO.read(ChessGUI.class.getResource("/Black_King.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(blackKing));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            }
        ...
        if (board[row][col].startsWith(QUEEN)) {
            if (board[row][col].endsWith(PLAYER_1)) {
                try {
                    Image whiteQueen = ImageIO.read(ChessGUI.class.getResource("/White_Queen.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(whiteQueen));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            } else {
                try {
                    Image blackQueen = ImageIO.read(ChessGUI.class.getResource("/Black_Queen.png"));
                    chessButtons[row][col].setIcon(new ImageIcon(blackQueen));
                } catch (Exception e) {
                    e.printStackTrace(System.out);
                }
            }
